...
# DBTITLE 1,First, let's Create a new pipeline. We can reuse some components of our existing pipeline
...
# DBTITLE 1,Add the classifier to the pipeline. We will use a Logistic Regression classifier
...
# DBTITLE 1,Let's train our Logistic Regression Classifier and get the validation metrics
import mlflow
import pandas as pd
...
# COMMAND ----------
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>AUTO GENERATED BY CONFLICT EXTENSION>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> presenter
